...
module.exports = {
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'ntkrnl32/notionnext-gitcus-data', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOOUvDCs4Co02q', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
